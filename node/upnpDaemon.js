...
var processJeedomSendQueue = function()
{
  ...
  request({uri:nextMessage.url, qs:{type:nextMessage.type}, method:nextMessage.method, json:nextMessage.data}, function(err, response, body) {
    if(err)
    {
...
server.listen({host: 'localhost',port: serverPort}, (e) => {
