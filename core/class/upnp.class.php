...
class upnp extends eqLogic
{
  ...
  public static function dependancy_info()
  {
    ...
    $return['progress_file'] = jeedom::getTmpFolder('upnp') . '/dependance';
  ...
  public static function dependancy_install()
  {
    ...
    return array('script' => dirname(__FILE__) . '/../../resources/nodejs.sh ' . jeedom::getTmpFolder('upnp') . '/dependance', 'log' => log::getPathToLog(__CLASS__ . '_dep'));
  ...
  public function toHtml($_version = 'dashboard')
  {
    ...
    if ($_version == 'dashboard' && strpos($this->getConfiguration('serviceId'), 'AVTransport') !== false && $this->getConfiguration('customDisplay')) {
      ...
      $processedCommand = array(
        'AbsoluteCounterPosition', 'AbsoluteTimePosition', 'AVTransportURI', 'AVTransportURIMetaData', 'CurrentMediaDuration'/*,
